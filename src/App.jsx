  ...
  async function createContent(event) {
    try {
      ...
      await ContentsApi().createContent(
        req.filme.value, req.genero.value, Number(req.avaliacao.value)
      ).then(data => {
        return data.json()
      }).then(res => {
        setContents([...contents, {
          id: res.contentId,
          filme: req.filme.value,
          genero: req.genero.value,
          avaliacao: Number(req.avaliacao.value)
        }])
  ...
  async function updateContent(event) {
    try {
      ...
      await ContentsApi().updateContent(
        selectedContent.id, req.filme.value, req.genero.value, Number(req.avaliacao.value)
      )
